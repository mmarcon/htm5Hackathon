(function () {
    ...
    APP.API = {};
    APP.API.Config = {
        freeSoundBaseURL: 'http://www.freesound.org/api/sounds/geotag/?min_lat={BB_MIN_LAT}&min_lon={BB_MIN_LNG}&max_lat={BB_MAX_LAT}&max_lon={BB_MAX_LNG}&sounds_per_page=10&api_key=1142723002b040a0b1f378dc8787bb70&fields=tags,preview-hq-mp3,preview-lq-mp3,original_filename,duration,geotag',
    ...
    F.retrieveSoundsFor = function (bb, success, error) {
        var url = APP.API.Config.freeSoundBaseURL,
            successFn, errorFn;
    ...
    L.retrieveEventsFor = function (pos, success, error) {
        var url = APP.API.Config.lastFMBaseURL,
            errorFn, successFn, deezer = new APP.API.Deezer();
    ...
    D.retrieveSoundsFor = function (meta, success, error) {
        var url = APP.API.Config.deezerBaseURL,
            errorFn, successFn;
